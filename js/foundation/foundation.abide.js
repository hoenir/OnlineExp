    ...
    valid_radio : function (el, required) {
      ...
      for (var i=0; i < count; i++) {
        if (valid) {
          ...
          $(group[i]).removeAttr('data-invalid').parent().parent().removeClass('error');
          $(group[i]).removeAttr('data-invalid').parent().parent().parent().removeClass('error');                   
        } else {
          $(group[i]).attr('data-invalid', '').parent().addClass('error');
          $(group[i]).attr('data-invalid', '').parent().parent().addClass('error');
          $(group[i]).attr('data-invalid', '').parent().parent().parent().addClass('error');
        }
      }
