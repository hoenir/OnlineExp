...
jsPsych.plugins["pacman"] = (function () {
    ...
    plugin.trial = function (display_element, trial) {
        ...
        function SoundManager(sounds) {
            ...
            if (values(sounds).some(function (sound) {
                    return !sound;
                })) {
        ...
        Pinky.prototype = new Ghost({
            ...
            calcTarget: function () {
                ...
                var pacman = getObject('pacman');
                return {
                    col: pacman.col + toDx(pacman.direction) * 4,
        ...
        function removeTransientEntities() {
            ['blinky', 'inky', 'pinky', 'clyde', 'bonus', 'bonusScore',
                'ghostScore', 'releaseTimer', 'modeSwitcher'
